...
public class NotStartedGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button backMenu = findViewById(R.id.go_to_menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.confirm_log_out:
                Toast.makeText(NotStartedGameActivity.this, "LOGGING OUT", Toast.LENGTH_LONG).show();
                FirebaseAuth.getInstance().signOut();
                Intent intent = new Intent(NotStartedGameActivity.this, LoginActivity.class);
                startActivity(intent);
                return true;
